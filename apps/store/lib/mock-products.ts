...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    compareAtPrice: { amount: 89.99, currency: "EUR" },
    condition: "new",
    availability: "in_stock",
    stockQty: 12,
  ...
  },
  {
    ...
    compareAtPrice: { amount: 39.9, currency: "EUR" },
    condition: "new",
    availability: "in_stock",
    stockQty: 18,
  ...
  },
  {
    ...
    price: { amount: 7.9, currency: "EUR" },
    compareAtPrice: { amount: 24.9, currency: "EUR" },
    condition: "new",
    availability: "in_stock",
    stockQty: 22,
  ...
  // AUTO PRECES
  {
    ...
    price: { amount: 9.9, currency: "EUR" },
    compareAtPrice: { amount: 29.9, currency: "EUR" },
    condition: "new",
    availability: "in_stock",
    stockQty: 14,
  ...
  },
  {
    ...
    compareAtPrice: { amount: 19.99, currency: "EUR" },
    condition: "new",
    availability: "in_stock",
    stockQty: 30,
  ...
  // SADZĪVES TEHNIKA
  {
    ...
    price: { amount: 199.0, currency: "EUR" },
  ...
  },
  {
    ...
    price: { amount: 19.0, currency: "EUR" },
    compareAtPrice: { amount: 79.0, currency: "EUR" },
    condition: "new",
    availability: "in_stock",
    stockQty: 8,
  ...
  // CITI PIEDĀVĀJUMI
  {
    ...
    compareAtPrice: { amount: 22.9, currency: "EUR" },
    condition: "new",
    availability: "in_stock",
    stockQty: 16,
  ...
  },
  {
    ...
    compareAtPrice: { amount: 49.0, currency: "EUR" },
    condition: "open_box",
